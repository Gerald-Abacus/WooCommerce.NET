...
namespace WooCommerceNET.WooCommerce
{
    ...
    public class Product
    {
        ...
        /// You might be wondering why the data type of stock_quantity is object, instead of int.
        /// Becuase when stock management is disabled, it will return null (empty string in json, which can't parse as int), but not 0.
        /// You will need to unbox it as int whenever needed.
        /// </summary>
        [DataMember(EmitDefaultValue = false)]
